...
class Offer extends Database {
    ...
    public function createOffer($user_id, $description, $proposal_id) {
        try {
            ...
            if ($e->errorInfo[1] == 1062) { // 1062 is the error code for a duplicate entry
                echo "<script>alert('You have already submitted an offer for this proposal.'); window.location.href = '../index.php';</script>";
                exit();
            }
            return false;
        }
