...
class Proposal extends Database {
     ...
     */
    public function createProposal($user_id, $subcategory_id, $description, $image, $min_price, $max_price) {
        $sql = "INSERT INTO Proposals (user_id, subcategory_id, description, image, min_price, max_price) VALUES (?, ?, ?, ?, ?, ?)";
        return $this->executeNonQuery($sql, [$user_id, $subcategory_id, $description, $image, $min_price, $max_price]);
    }
